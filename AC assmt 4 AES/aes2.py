...
def main():
    ...
    print_state([plaintext[i:i+4] for i in range(0, 16, 4)], "Plaintext")
    print_state([key[i:i+4] for i in range(0, 16, 4)], "Key")

    ciphertext = encrypt(plaintext, key, rounds)
    print_state([ciphertext[i:i+4] for i in range(0, 16, 4)], "Ciphertext")
    ...
    if ciphertext == expected_ciphertext:
        ...
        print("Expected:")
        print_state([expected_ciphertext[i:i+4] for i in range(0, 16, 4)], "Expected Ciphertext")
